 ...
 */
public class MainNewsFragmentTest {
    ...
    public void testGson() throws Exception {
        ...
        List<StoryEntry> storyEntryList = latest.getStories();
        if (storyEntryList != null) {
            System.out.println(storyEntryList.size() + "");
        } else {
            System.out.println( "storyEntryList = null");
        }
    }
}